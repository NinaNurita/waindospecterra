...
Plugin URI: http://codigojavaoracle.com/plugin-toolbar-to-share-wordpress/
Description: This plugin shows sharing buttons for Facebook, Twitter, and Google +,  in a little Toolbar.
Version: 1.0 
Author: Miguel Berlanga, Yolanda Jimenez, Eva Romero
Author URI: http://codigojavaoracle.com/plugin-toolbar-to-share-wordpress/
*/
...
if(isset($_REQUEST["google_toolbar"])){  
    $dato_toolbar6 = $_REQUEST["google_toolbar"];
    update_option('google_toolbar',$dato_toolbar6);  
}
...
add_option('google_toolbar', 'Google+ User'); 
...
<font style=\"font-style: bold; font-weight: bold;\">Google plus+:</font> <input type=\"text\" name=\"google_toolbar\" id=\"valor5\" value=\"$google1_toolbar\" style=\"width:740px; margin: 0 0 0 10px;display:block; border: 1px solid #999; height: 25px; -webkit-box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3); -moz-box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3);\"/>
...
<iframe src="http://www.facebook.com/plugins/like.php?href='. $elpermalink_toolbarf .'
&amp;layout=button_count&amp;show_faces=true&amp;width=100&amp;action=like&amp;font=arial&amp;colorscheme=light" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; line-height:20px; margin:5px 15px 0 0; width:100px; height:20px"></iframe>
...
<div class="g-plusone"  data-size="medium" data-href="'.$elpermalink_toolbarg.'"></div>
...
<script type="text/javascript">
  ...
  if ($publi_toolbar1_toolbar == 'Si'){  
     ...
     $banner_toolbar= $banner_toolbar . '  
        ...
        <a href="http://www.codigojavaoracle.com/" title="Developed by CodigoJavaOracle.com" target="_blank">CJO</a>
        </div>';

} 
   else { 
    $banner_toolbar= $banner_toolbar .' <div align="right" id="divletra" class="divletra" >Ver. 1.0</div> ';
   }
