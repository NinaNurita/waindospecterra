                	...
                	<div class="w90 overflowauto header_section rbg5b">
                    	...
                    	<div class="maxwidth overflowauto">
                            ...
                            <div class="cycle-slideshow" 
                                ...
                                data-cycle-overlay-template='<div class="r100 rfltlft">
                                                	<div class="w90">
                                                        <h2 class="h336tt22lr bmargin5px"><a href="{{link}}">{{title}}</a></h2>
                                                        <p class="rdispaly">{{desc}}</p>
                                                    </div>
                                                </div>'>
                                ...
                                <img src="
									<?php 
                                        if( of_get_option('slide_one_image') ){
                                            ...
                                            echo get_stylesheet_directory_uri().'/images/slide1.jpg';
                                        }
                                    ?> 								
                                " 
                                    data-cycle-title="
