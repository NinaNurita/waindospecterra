...
By default custom header is not displayed. To display custom header please select "I Want to use custom header" in "Header/Slider settings" tab of theme options page.
...
source-sans-pro license : http://www.fontsquirrel.com/license/source-sans-pro
