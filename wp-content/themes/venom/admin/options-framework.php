...
if ( !function_exists( 'add_action' ) ) {
	_e("Hi there!  I'm just a little extension, don't mind me.", 'Venom');
	exit;
}
    ...
    <div class="new_options_container">
    	...
    	<div id="countrytabs" class="new_options_container_middle">
			...
			<ul class="shadetabs">
                ...
                <li class="big"><a href="#country3"><h6><?php echo __('Slider', 'Venom'); ?></h6><p><?php echo __('Settings', 'Venom'); ?></p></a></li>
                ...
                <li class="small"><a href="#country7"><p><?php echo __('Biz Two Settings', 'Venom'); ?></p></a></li>                               
                <li class="small"><a href="#country9"><p><?php echo __('Standard Page Settings', 'Venom'); ?></p></a></li>
