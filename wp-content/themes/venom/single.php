								...
								<div class="r100">
                                    ...
                                    <div class="single_np">
                                                          	...
                                                          	<?php 
																...
																previous_post_link('<div class="single_np_prev"><p class="single_np_prev_np">'.__('Previous Post' , 'Venom').'</p><p> %link</p></div>');
															...
															?>                                                            
                                                          	...
                                                          	<?php 
																...
																next_post_link('<div class="single_np_next"><p class="single_np_next_np">'.__('Next Post' , 'Venom').'</span></p><p> %link</p></div>');
